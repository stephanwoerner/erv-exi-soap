...
class Exi_Service extends \SoapClient
{
    ...
    private static $classmap = [
        ...
        'amazonPayment'                     => 'StephanWoerner\\ErvExiSoap\\Model\\amazonPayment',
        ...
        'creditcardHolderType'              => 'StephanWoerner\\ErvExiSoap\\Model\\creditcardHolderType',
        ...
        'apPaymentType'                     => 'StephanWoerner\\ErvExiSoap\\Model\\apPaymentType',
        'apAmount'                          => 'StephanWoerner\\ErvExiSoap\\Model\\apAmount',
        'psd2ParameterType'                 => 'StephanWoerner\\ErvExiSoap\\Model\\psd2ParameterType',
        ...
        'requestPayPageUrl'                 => 'StephanWoerner\\ErvExiSoap\\Model\\requestPayPageUrl',
        'payPageData'                       => 'StephanWoerner\\ErvExiSoap\\Model\\payPageData',
        'responsePayPageUrl'                => 'StephanWoerner\\ErvExiSoap\\Model\\responsePayPageUrl',
        'payPageUrl'                        => 'StephanWoerner\\ErvExiSoap\\Model\\payPageUrl',
    ...
    {
        return $this->__soapCall('requestOffer', [$requestOffer]);
    }
    ...
    {
        return $this->__soapCall('requestCancellation', [$requestCancellation]);
    }
    ...
    {
        return $this->__soapCall('requestBooking', [$requestBooking]);
    }
    ...
    {
        return $this->__soapCall('requestPreContractualInformation', [$requestPreContractualInformation]);
    }

    /**
     * @param requestPayPageUrl $requestPayPageUrl
     * @return responsePayPageUrl
     */
    public function requestPayPageUrl(requestPayPageUrl $requestPayPageUrl)
    {
        return $this->__soapCall('requestPayPageUrl', [$requestPayPageUrl]);
    }
